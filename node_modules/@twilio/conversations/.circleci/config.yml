  ...
  prepare-publish-version:
    ...
    steps:
      - run:
          ...
          command: |
            npx -p circleci-build-publisher@1.1.0 prepare-publish-version
          working_directory: *workspace
  ...
  strip-private-prefix:
    ...
    steps:
      - run:
          ...
          command: |
            npx -p circleci-build-publisher@1.1.0 strip-private-prefix "@twilio" --conversations
          working_directory: *workspace
  ...
  npm-publish:
    ...
    steps:
      - run:
          name: "Publish to NPM"
          command: |
            npm publish --verbose --tag=$(npx -p circleci-build-publisher@1.1.0 get-channel-name)
            echo "********************"
            echo "*** Package Hash ***"
            echo "********************"
            echo "*** Lib:"
    ...
    steps:
      ...
      - run:
          ...
          command: |
            ...
            export SDK_NAME=twilio-conversations-js
      ...
      - integration-test:
          ...
          matrix:
            parameters:
              ...
              twilio-realm:
                - us1
                #- ie1 -- conversations not yet supported in ie1
          context:
            - rtd-sdk-js-npm
            - rtd-sdk-shared-tokengen
            - rtd-sdk-js-tests
