...
This chatbox was made based on the open source project [Twilio Conversations](https://www.twilio.com/docs/conversations).

# Configuring and getting started

This chatbox requires a Twilio account and a working Conversations Service SID.
