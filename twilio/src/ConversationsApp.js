...
class ConversationsApp extends React.Component {
  ...
  getToken = () => {
    ...
    const myToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..-wLb8ABEZhZNpEWFPeQs6LqfV9BQVjq_6y1Z3DooYQo";
      ...
      return (
        <div className="conversations-window-wrapper">
          <Layout className="conversations-window-container">
            <Header
              style={{ display: "flex", alignItems: "center", padding: 0 , colour:'#e83030'}}
            >
              <div
                style={{
                  maxWidth: "250px",
